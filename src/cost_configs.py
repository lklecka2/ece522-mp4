...
cpu_memory_percentages = [80, 60, 40, 20]
...
output_folder           ../results/{MODEL}/1024-hostdram{PERCENT} 
...
output_base_dir = "gen_cost_configs"
    ...
    for model, batch_sizes in models_batchsizes:
        for batch_size in batch_sizes:
            ...
            for percent in cpu_memory_percentages:
                ...
                output_folder = f"results/{model}/1024-hostdram{percent}"
